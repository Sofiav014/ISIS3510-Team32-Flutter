...
class AppColors {
  static const Color primaryNeutral = Color(0xFFFFFFFF); // White
  ...
  static const Color greenAccent = Color(0xFF72EB93); // Green
  static const Color redAccent = Color(0xFFE3533A); // Red
}
