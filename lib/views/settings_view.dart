  ...
  final List<Map<String, String>> sportsData = [
    {
      'key': 'basketball',
      'text': 'Basketball',
      'icon': 'assets/icons/initiation/basketball-logo.svg',
    },
    {
      'key': 'football',
      'text': 'Football',
      'icon': 'assets/icons/initiation/football-logo.svg',
    },
    {
      'key': 'volleyball',
      'text': 'Volleyball',
      'icon': 'assets/icons/initiation/volleyball-logo.svg',
    },
    {
      'key': 'tennis',
      'text': 'Tennis',
      'icon': 'assets/icons/initiation/tennis-logo.svg',
    },
  ];
  ...
  Widget build(BuildContext context) {
    return OutlinedButton(
      style: OutlinedButton.styleFrom(
        ...
        side: BorderSide(
          color: AppColors.settings(context),
          width: 2,
        ),
      ),
      onPressed: () {
